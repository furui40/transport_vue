...
const AdminUploadFile = () => import('../views/admin/AdminUploadFile.vue');
...
const DownloadFile = () => import('../views/download/FileDownload.vue');
...
const routes = [
  ...
  { path: '/admin/adminuploadfile', component: AdminUploadFile, meta: { requiresAuth: true, requiresAdmin: true } }, // 需要管理员权限
  ...
  { path: '/download/filedownload', component: DownloadFile, meta: { requiresAuth: true } }, // 需要登录
